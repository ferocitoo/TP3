...
CJOLI_thetadot=CJOLI.iloc[:,1]
CJOLI_theta=CJOLI.iloc[:,2]
...
ax.plot(theta1,thetadot1,color="blue",label="Exp. 1")
ax.plot(theta2,thetadot2,color="red",label="Exp. 2")
ax.plot(theta3,thetadot3,color="green",label="Exp. 3")
ax.plot(theta4,thetadot4,color="orange",label="Exp. 4")
...
max_freq1 = positive_freqs1[positive_freqs1>0.2][np.argmax(positive_fft1[positive_freqs1>0.2])]
max_freq2 = positive_freqs2[positive_freqs2>0.2][np.argmax(positive_fft2[positive_freqs2>0.2])]
max_freq3 = positive_freqs3[positive_freqs3>0.2][np.argmax(positive_fft3[positive_freqs3>0.2])]
max_freq4 = positive_freqs4[positive_freqs4>0.2][np.argmax(positive_fft4[positive_freqs4>0.2])]

print(positive_freqs1[positive_freqs1>0.2])
np.argmax
print(len(positive_freqs1[positive_freqs1>0.2]))
print(positive_fft1[positive_freqs1>0.2])
print(len(positive_freqs1[positive_freqs1>0.2]))

print(max_freq1,max_freq2,max_freq3,max_freq4)
...
ax.axvline(x=(1/3)*max_freq3, color="black", linestyle="--",label = r"$\frac{1}{3}\nu^\star$")
ax.axvline(x=(5/3)*max_freq3, color="black", linestyle="-.",label = r"$\frac{2}{3}\nu^\star$")
...
#Calculate the Lyapunov exponent
delta_phase12 = np.sqrt((theta1-theta2)**2 + ((thetadot1-thetadot2))**2)
delta_phase13 = np.sqrt((theta1-theta3)**2 + ((thetadot1-thetadot3))**2)
delta_phase14 = np.sqrt((theta1-theta4)**2 + ((thetadot1-thetadot4))**2)
delta_phase23 = np.sqrt((theta2-theta3)**2 + ((thetadot2-thetadot3))**2)
delta_phase24 = np.sqrt((theta2-theta4)**2 + ((thetadot2-thetadot4))**2)
delta_phase34 = np.sqrt((theta3-theta4)**2 + ((thetadot3-thetadot4))**2)
...
ax,fig = u.create_figure_and_apply_format((8,6),xlabel="Time [s]", ylabel=r"$\delta_{13}$ [a.u.]")
...
#make an exponential fit on the first half of the data
delta_phase_fit = delta_phase14[25:77]
tfit = t[25:77]

fit = np.polyfit(tfit,np.log(delta_phase_fit),1)

ax,fig = u.create_figure_and_apply_format((8,6),xlabel="Time [s]", ylabel=r"$\delta_{14}$ [a.u.]")
ax.plot(t,delta_phase14, label="Data", color="blue")
ax.set_yscale("log")

# ax.scatter(t[77],delta_phase14[77],color="red",s=30)
# ax.scatter(t[25],delta_phase14[25],color="red",s=30)
...
u.set_legend_properties(ax,fontsize=18)
fig.savefig("/workspaces/TP-Chaos/TP_Chaos/Figures/Config1_Cond1_lyapunov14.pdf")


#make an exponential fit on the first half of the data
delta_phase_fit = delta_phase23[15:60]
tfit = t[15:60]

fit = np.polyfit(tfit,np.log(delta_phase_fit),1)

ax,fig = u.create_figure_and_apply_format((8,6),xlabel="Time [s]", ylabel=r"$\delta_{23}$ [a.u.]")
ax.plot(t,delta_phase23, label="Data", color="blue")
ax.set_yscale("log")

# ax.scatter(t[60],delta_phase23[60],color="red",s=30)
# ax.scatter(t[15],delta_phase23[15],color="red",s=30)
...
u.set_legend_properties(ax,fontsize=18)
fig.savefig("/workspaces/TP-Chaos/TP_Chaos/Figures/Config1_Cond1_lyapunov23.pdf")



#make an exponential fit on the first half of the data
delta_phase_fit = delta_phase24[12:87]
tfit = t[12:87]

fit = np.polyfit(tfit,np.log(delta_phase_fit),1)

ax,fig = u.create_figure_and_apply_format((8,6),xlabel="Time [s]", ylabel=r"$\delta_{24}$ [a.u.]")
ax.plot(t,delta_phase24, label="Data", color="blue")
ax.set_yscale("log")

# ax.scatter(t[87],delta_phase24[87],color="red",s=30)
# ax.scatter(t[12],delta_phase24[12],color="red",s=30)
...
u.set_legend_properties(ax,fontsize=18)
fig.savefig("/workspaces/TP-Chaos/TP_Chaos/Figures/Config1_Cond1_lyapunov24.pdf")



#make an exponential fit on the first half of the data
delta_phase_fit = delta_phase12[25:87]
tfit = t[25:87]

fit = np.polyfit(tfit,np.log(delta_phase_fit),1)

ax,fig = u.create_figure_and_apply_format((8,6),xlabel="Time [s]", ylabel=r"$\delta_{12}$ [a.u.]")
ax.plot(t,delta_phase12, label="Data", color="blue")
ax.set_yscale("log")

# ax.scatter(t[87],delta_phase12[87],color="red",s=30)
# ax.scatter(t[25],delta_phase12[25],color="red",s=30)
...
u.set_legend_properties(ax,fontsize=18)
fig.savefig("/workspaces/TP-Chaos/TP_Chaos/Figures/Config1_Cond1_lyapunov13.pdf")
...
ax.plot(CJOLI_theta,CJOLI_thetadot,color="black",linestyle=':', linewidth=0.5)
...
exp = [3.74,4.53,1.22,2.23,9.23,4.50]

print("exp  = ",np.mean(exp),np.std(exp))